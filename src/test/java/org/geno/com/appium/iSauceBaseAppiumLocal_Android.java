...
public class iSauceBaseAppiumLocal_Android implements UDBase {
...
//            capabilities.setCapability("idle-timeout","400");
            ...
            // set up local appium driver for android
            ...
            capabilities_appium.setCapability("device", "Android");
            capabilities_appium.setCapability("browserName", "");
            capabilities_appium.setCapability("platform", "Mac");
            capabilities_appium.setCapability("version", "4.2");
            capabilities_appium.setCapability("app", app);
            capabilities_appium.setCapability("app-package", "com.geno.themove");
            capabilities_appium.setCapability("app-activity", "HomePage");
