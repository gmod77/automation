...
public class iSauceBaseAppiumAndWeb implements SauceOnDemandSessionIdProvider, SauceOnDemandAuthenticationProvider, UDBase {

    public SauceOnDemandAuthentication authentication;

    protected WebDriver client;
    protected WebDriver client_appium;
    ...
    public void setUp(@Optional("") String username,
        ...
        if (StringUtils.isNotBlank(browserProp) && StringUtils.isNotBlank(platformProp)) {
            ...
            // set up local appium driver for iphone
...
// File appDir = new File("/Users/gmodin/Documents");
            ...
            capabilities_appium.setCapability(CapabilityType.BROWSER_NAME, "iOS");
            capabilities_appium.setCapability(CapabilityType.VERSION, "6.1");
            capabilities_appium.setCapability(CapabilityType.PLATFORM, "Mac");
            capabilities_appium.setCapability("app", app.getAbsolutePath());

            client_appium = new RemoteWebDriver(new URL("http://127.0.0.1:4723/wd/hub"), capabilities_appium);
            values = new ArrayList<Integer>();

            // set up sauce appium driver for iphone

            //push the app up to sauce:
            //curl -u cloudbees_geno:3f541489-1c79-457b-9b26-ece624eff198 -X POST "http://saucelabs.com/rest/v1/storage/cloudbees_geno/TheMove.zip?overwrite=yeah" -H "Content-Type: application/octet-stream" --data-binary @TheMove.zip

            //DesiredCapabilities capabilities = new DesiredCapabilities();
// capabilities_appium.setCapability("app","http://www.danielcharms.com/tnm/TheMove.zip");
...
// values = new ArrayList<Integer>();
            ...
            // set up appium driver for android

// File classpathRoot = new File(System.getProperty("user.dir"));
// System.out.println(classpathRoot);
// File appDir = new File(classpathRoot,"../../../../Users/gmodin/projects/Android/bin/");
// File app = new File(appDir, "TheMove.apk");
//
// System.out.println("App's directory: "+ app + "\n");
//
// DesiredCapabilities capabilities = new DesiredCapabilities();
...
// capabilities.setCapability("app-package", "com.geno.themove");
// capabilities.setCapability("app-activity", "HomePage");
//
// client_appium = new RemoteWebDriver(new URL("http://127.0.0.1:4723/wd/hub"), capabilities);
// values = new ArrayList<Integer>();
