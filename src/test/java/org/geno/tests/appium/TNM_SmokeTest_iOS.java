...
public class TNM_SmokeTest_iOS extends iTestCaseTNMAppium_iOS {
...
//            logoutUD();
    ...
    public void testTNMBasicFlowAtlanticCity() throws Exception {
        ...
        //for(int i =0; i<10; i++)
        {
            ...
            performFoodAndDrinksSearch_afterCityChoice("Breakfast","with nobody in particular");
            //Reporter.log("Search performed, arrived @ Results List");
...
//            logoutUD();
    ...
    public void testTNMBasicFlowHamptons() throws Exception {
        ...
        //for(int i =0; i<10; i++)
        {
            ...
            performFoodAndDrinksSearch_afterCityChoice("Brunch","with nobody in particular");
            //Reporter.log("Search performed, arrived @ Results List");
...
//            logoutUD();
    ...
    @Test
    public void testTNMBasicFlowNashville() throws Exception {

        driver = getAppiumDriver();

        String DATEFORMAT="HHmmssSSS";
        String email = "udtestergene+"+"Nashville+"+generateDate(DATEFORMAT)+"@gmail.com";
        String password = "12345";
        String user_state = "";
        ...
        //for(int i =0; i<10; i++)
        {
            ...
            searchForVenue("Headquarters", "Headquarters, 4902 Charlotte Pike (at 49th Ave N)");
            //Reporter.log("Search for Venue Performed successfully, arrived @ a Venue View");
            ...
            checkVenueIsFavoriteSignedIn("Headquarters", "Headquarters, 4902 Charlotte Pike (at 49th Ave N)");
...
//            logoutUD();
    ...
    @Test
    public void testTNMBasicFlowPhoenix() throws Exception {

        driver = getAppiumDriver();

        String DATEFORMAT="HHmmssSSS";
        String email = "udtestergene+"+"Phoenix+"+generateDate(DATEFORMAT)+"@gmail.com";
        String password = "12345";
        String user_state = "";
        ...
        //for(int i =0; i<10; i++)
        {
            ...
            searchForVenue("Gallo Blanco", "Gallo Blanco, 401 W Clarendon Ave (at N 4th Ave)");
            //Reporter.log("Search for Venue Performed successfully, arrived @ a Venue View");
            ...
            checkVenueIsFavoriteSignedIn("Gallo Blanco", "Gallo Blanco, 401 W Clarendon Ave (at N 4th Ave)");
...
//            logoutUD();
    ...
    @Test
    public void testTNMBasicFlowSanDiego() throws Exception {

        driver = getAppiumDriver();

        String DATEFORMAT="HHmmssSSS";
        String email = "udtestergene+"+"SanDiego+"+generateDate(DATEFORMAT)+"@gmail.com";
        String password = "12345";
        String user_state = "";
        ...
        //for(int i =0; i<10; i++)
        {
            ...
            searchForVenue("Cafe Athena", "Cafe Athena, 1846 Garnet Ave (at Kendall St)");
            //Reporter.log("Search for Venue Performed successfully, arrived @ a Venue View");
            ...
            checkVenueIsFavoriteSignedIn("Cafe Athena", "Cafe Athena, 1846 Garnet Ave (at Kendall St)");
...
//            logoutUD();
    ...
    @Test
    public void testTNMBasicFlowWashingtonDC() throws Exception {
